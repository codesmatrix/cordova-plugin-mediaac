 ...
 */
public class AndroidPlayer extends Player implements OnCompletionListener, OnPreparedListener, OnErrorListener {
...
//    private static int MEDIA_ERR_NONE_SUPPORTED = 4;
     ...
     */
    public AndroidPlayer(AudioHandler handler, String id, String file) {
    ...
    public void startRecording(String file) {
        switch (this.mode) {
        case PLAY:
            Log.d(LOG_TAG, "AndroidPlayer Error: Can't record in play mode.");
        ...
        case NONE:
            ...
            break;
        case RECORD:
            Log.d(LOG_TAG, "AndroidPlayer Error: Already recording.");
            sendErrorStatus(MEDIA_ERR_ABORTED);
        }
    }
    ...
    public void pausePlaying() {
        ...
        if (this.state == STATE.MEDIA_RUNNING && this.player != null) {
            ...
            Log.d(LOG_TAG, "AndroidPlayer Error: pausePlaying() called during invalid state: " + this.state.ordinal());
    ...
    public void stopPlaying() {
        if ((this.state == STATE.MEDIA_RUNNING) || (this.state == STATE.MEDIA_PAUSED)) {
            ...
            Log.d(LOG_TAG, "AndroidPlayer Error: stopPlaying() called during invalid state: " + this.state.ordinal());
            sendErrorStatus(MEDIA_ERR_NONE_ACTIVE);
        }
    }
    ...
    public boolean onError(MediaPlayer player, int arg1, int arg2) {
        Log.d(LOG_TAG, "AndroidPlayer.onError(" + arg1 + ", " + arg2 + ")");
    ...
    private boolean playMode() {
        ...
        case PLAY:
            break;
        case RECORD:
            Log.d(LOG_TAG, "AndroidPlayer Error: Can't play in record mode.");
            sendErrorStatus(MEDIA_ERR_ABORTED);
        ...
        if (playMode()) {
            switch (this.state) {
                ...
                case MEDIA_LOADING:
                    ...
                    Log.d(LOG_TAG, "AndroidPlayer Loading: startPlaying() called during media preparation: " + STATE.MEDIA_STARTING.ordinal());
                    this.prepareOnly = false;
                    return false;
                case MEDIA_STARTING:
                case MEDIA_RUNNING:
                ...
                default:
                    Log.d(LOG_TAG, "AndroidPlayer Error: startPlaying() called during invalid state: " + this.state);
                    sendErrorStatus(MEDIA_ERR_ABORTED);
            }
        }
        return false;
